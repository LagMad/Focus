...
const Note = ({ title, content, pinned, onEdit, onClick }) => {
  return (
    <div className="flex flex-col w-full max-h-96 justify-start items-center bg-cust-white p-5 gap-3 rounded-2xl border-[1px] border-cust-white drop-shadow-2xl self-start">
