...
const Button = ({
  ...
  const getButtonVariation = (variation, path) => {
    switch (variation) {
      case "primary":
        return "py-2 md:py-3 px-3 md:px-16 text-xl bg-cust-pink-light hover:bg-cust-pink-lighter rounded-full text-white font-bold font-SfProDisplay";
      case "primary-smaller":
        return "py-2 md:py-2 px-3 md:px-10 text-xl bg-cust-pink-light hover:bg-cust-pink-lighter rounded-full text-white font-bold font-SfProDisplay";
      ...
      case "navbar":
        return isActive(path)
          ? "text-white rounded-none border-b-cust-white hover:border-b-cust-pink-light border-b-2 text-lg font-bold"
          : "text-white rounded-none border-b-transparent hover:border-b-cust-white border-b-2 text-lg font-bold";
      default:
        return "";
    }
  };
