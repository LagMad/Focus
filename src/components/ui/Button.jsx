...
const Button = ({
  ...
  const getButtonVariation = (variation, path) => {
    switch (variation) {
      ...
      case "primary-smallest":
        return "py-2 px-3 md:px-6 text-base bg-cust-pink-light hover:bg-cust-pink-lighter border-2 border-cust-pink-light hover:border-cust-pink-lighter rounded-full text-cust-white font-bold font-SfProDisplay";
      case "primary-smallest-alt":
        return "py-2 px-3 md:px-6 text-base bg-cust-white hover:bg-cust-pink-lighter border-2 border-cust-pink-light hover:border-cust-pink-lighter rounded-full text-cust-black font-bold font-SfProDisplay";
      case "secondary":
  ...
  return (
    <button
      ...
      value={value}
      disabled={disabled}
      className={`${className} ${getButtonVariation(variation, path)}
