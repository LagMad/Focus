    ...
    <MainLayout>
      <div className="flex flex-col w-full min-h-screen justify-start items-center gap-5 px-5 pb-16 bg-HomeBG bg-cover bg-no-repeat">
        ...
        <div className="flex flex-row justify-center items-center w-3/4 gap-5">
          <div className="flex flex-row w-1/2 h-auto justify-between items-center bg-cust-pink-lighter rounded-2xl py-7 px-16 font-bold text-3xl bg-opacity-30 backdrop-blur-xl drop-shadow-2xl border-[1px] border-cust-white">
            Edit Profile
          </div>
          <button
